      ...
      return Stack(
        children: [
              ...
              child: Center(
                child: Column(
                  ...
                  children: [
                    ...
                    const Text('Register @ Stay Healthy', style: TextStyle(color: Colors.white, fontSize: 28, fontWeight: FontWeight.bold),),
          ...
          Align(
            ...
            child: FlatButton(
              onPressed: (){
                context.bloc<SignInFormBloc>().add(const SignInFormEvent.showSignInPressed());
              },
              child: const Text('Already Registered ?', style: TextStyle(color: Colors.white, fontSize: 16)),
            )
          )
        ],
      );
